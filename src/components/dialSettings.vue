  ...
  export default {
    ...
    methods: {
      ...
      selectType(action) {
        ...
        console.log(this.selectAction.type);
      ...
      configButton(deletebtn) {
        ...
        this.dangerRoute = false;
        this.dangerKey = false;
        console.log(this.selectAction, this.selectRoute, this.action);
        if (
    ...
    watch: {
      model() {
        ...
        if (this.data.type == 0) {
          ...
          console.log(this.data.data.action);
          ...
          if (this.selectRoute.value?.length > 0) {
            this.selectRouteText = this.selectRoute.text_value
              ? this.selectRoute.text_value
              : '';
          }
